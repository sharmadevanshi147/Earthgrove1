/**
 * Run once to seed Sanity with all projects from the React app:
 *   node scripts/importProjects.mjs
 * Requires SANITY_AUTH_TOKEN env var (or falls back to sanity login).
 */
...
async function importProjects() {
  ...
  console.log(`Imported ${result.results.length} projects.`)
}
